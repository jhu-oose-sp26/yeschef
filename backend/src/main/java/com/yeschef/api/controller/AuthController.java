...
public class AuthController {
    ...
    // redirectTo is generated by the client (Linking.createURL) so it is platform-appropriate:
    // frontend://update-password on native, http://host/update-password on web.
    @PostMapping("/forgot-password")
    public ResponseEntity<Map<String, String>> forgotPassword(@RequestBody Map<String, String> body) {
        authService.forgotPassword(body.get("email"), body.get("redirectTo"));
